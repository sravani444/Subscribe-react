...
<img src="https://assets.ccbp.in/frontend/content/react-js/welcome-app-output-v2.gif" alt="login-app-output" style="max-width:70%;box-shadow:0 2.8px 2.2px rgba(0, 0, 0, 0.12)">
</div>
<br/>
...
<div style="background-color:  #f0bb03 ; width: 150px; padding: 10px; color: yellow">Hex:  #f0bb03</div>
